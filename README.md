...
Este repositorio tiene completadas las fases de motor puro de imagen y texto:
...
TodavÃ­a no estÃ¡ listo para instalarse ni usarse dentro de ComfyUI. No existe aÃºn `nodes.py`, renderer completo, layouts de slide ni workflow de ComfyUI.
...
El proyecto separarÃ¡ el motor puro de composiciÃ³n de la integraciÃ³n con ComfyUI:
...
No instales todavÃ­a este repositorio en `custom_nodes`. La integraciÃ³n con ComfyUI se realizarÃ¡ despuÃ©s de validar el renderer independiente.
