    ...
    def INPUT_TYPES(cls) -> dict[str, dict[str, Any]]:
        ...
        return {
            "required": {
                ...
                "contain_fill_mode": (("transparent", "cell_color"), {"default": "transparent"}),
                ...
                "label_padding_top": ("INT", {"default": 6, "min": 0, "max": 256, "step": 1}),
                "label_padding_bottom": ("INT", {"default": 10, "min": 0, "max": 256, "step": 1}),
                "label_after_gap": ("INT", {"default": 20, "min": 0, "max": 512, "step": 1}),
