...
This folder stores publication-safe images used by the public README.

Included synthetic renderer outputs:
...
- `node-interface.png`: screenshot of the `HLT · Slide Composer` node visible in ComfyUI after a clean install.

Do not add screenshots that show private file paths, user names, API tokens, local model names, private prompts, or unpublished client imagery.
